  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar maxWidth="xl" isBordered>
        <NavbarBrand>
          <Link to="/" className="text-xl font-bold text-[#006FEE]">
            Bingo Web
          </Link>
        </NavbarBrand>
        ...
        <NavbarContent className="hidden gap-4 sm:flex" justify="center">
          <NavbarItem>
            <Link to="/" className="text-foreground transition-colors hover:text-[#006FEE]">
              {t('nav.home')}
            </Link>
          </NavbarItem>
          <NavbarItem>
            <Link to="/about" className="text-foreground transition-colors hover:text-[#006FEE]">
              {t('nav.about')}
            </Link>
          </NavbarItem>
        </NavbarContent>
