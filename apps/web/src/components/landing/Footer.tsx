// ABOUTME: Landing page footer section
// ABOUTME: Multi-column footer with links, social icons, and copyright
...
const FOOTER_LINKS = {
  product: ['features', 'documentation', 'integrations', 'pricing'],
  resources: ['blog', 'community', 'showcase', 'helpCenter'],
